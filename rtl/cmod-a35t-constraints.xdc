...
set_property -dict {PACKAGE_PIN M3  IOSTANDARD TMDS_33} [get_ports {TMDSn[2]}]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property -dict {PACKAGE_PIN L3  IOSTANDARD TMDS_33} [get_ports {TMDSp[2]}]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
#set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { TPDSn_clock  }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
set_property -dict {PACKAGE_PIN K3  IOSTANDARD TMDS_33} [get_ports {TMDSn[1]}]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { pio5  }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
#set_property -dict { PACKAGE_PIN H1    IOSTANDARD TMDS_33 } [get_ports { TMDSp[1]  }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
...
set_property -dict {PACKAGE_PIN J3  IOSTANDARD TMDS_33} [get_ports {TMDSp[1]}]; #IO_L7P_T1_AD6P_35 Sch=pio[10]
set_property -dict { PACKAGE_PIN J1 IOSTANDARD TMDS_33} [get_ports { TMDSn[0]}]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
set_property -dict {PACKAGE_PIN K2  IOSTANDARD TMDS_33} [get_ports {TMDSp[0]}];  # #IO_L5P_T0_AD13P_35 Sch=pio[12]
#set_property -dict { PACKAGE_PIN L1 IOSTANDARD TMDS_33}  [get_ports {TMDSn[0]}]; #IO_L6N_T0_VREF_35 Sch=pio[13]
#set_property -dict {PACKAGE_PIN L2  IOSTANDARD TMDS_33} [get_ports {TMDSn_clock}]; # #IO_L5N_T0_AD13N_35 Sch=pio[14]
set_property -dict {PACKAGE_PIN M1 IOSTANDARD TMDS_33} [get_ports TMDSn_clock]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
#set_property -dict { PACKAGE_PIN N3    IOSTANDARD TMDS_33 } [get_ports { TMDSp_clock }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
#set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { pio19 }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]
set_property -dict {PACKAGE_PIN M2  IOSTANDARD TMDS_33} [get_ports {TMDSp_clock}];  #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]
...
#set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports { uart_txd }]; #IO_L2P_T0_34 Sch=pio[26]
#set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports { uart_rxd }]; #IO_L2N_T0_34 Sch=pio[27]
...
#set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { blue[0] }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { clk_25mhz }]; #IO_L19P_T3_34 Sch=pio[45]
#set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { clk_250mhz }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
#set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports hsync]
#set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports vsync]
...
#set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clkfbout_system_clock] -group [get_clocks -include_generated_clocks clkfbout_system_clock_1]
#set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clk_250mhz_system_clock] -group [get_clocks -include_generated_clocks clk_250mhz_system_clock_1]
#set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clk_25mhz_hdmi_system_clock] -group [get_clocks -include_generated_clocks clk_25mhz_hdmi_system_clock_1]
